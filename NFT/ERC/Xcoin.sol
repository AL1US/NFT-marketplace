...
contract Xcoin is ERC20 {
    ...
    constructor(address _owner) ERC20("Xcoin", "X") {
        ...
        _mint(ownerERC20, INITIAL_SUPPLY);

        user[ownerERC20] = structUser("Owner", "XCoinReferal31415", 0);
        ...
        // ERC20._transfer(ownerERC20, 0x70997970C51812dc3A010C7d01b50e0d17dc79C8, 200_000);

        // user[0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC] = structUser("Max", "PROFI90F72024", 0);
        // ERC20._transfer(ownerERC20, 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC, 300_000);

        // user[0x90F79bf6EB2c4f870365E785982E1f101E93b906] = structUser("Jack", "PROFI15d32024", 0);
        // ERC20._transfer(ownerERC20, 0x90F79bf6EB2c4f870365E785982E1f101E93b906, 400_000);
    }
}